...
import com.jun.xiaoquren.view.model.ParkingMyListViewHolder;
...
public class ParkingMyListViewAdapter extends BaseAdapter {
	
	public static final String CLASSNAME = "ParkingMyListViewAdapter";
	...
	public ParkingMyListViewAdapter(Activity context, List<ParkingStallInfo> parkingStallInfoList) {
	...
	public View getView(final int position, View view, ViewGroup parent) {
		final ParkingMyListViewHolder parkingStallInfoHolder;
		if (view == null) {
			parkingStallInfoHolder = new ParkingMyListViewHolder();
			view = inflater.inflate(R.layout.parking_my_list_item, null);
			...
			parkingStallInfoHolder = (ParkingMyListViewHolder) view.getTag();
		}
